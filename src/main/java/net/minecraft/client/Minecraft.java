    ...
    private void clickMouse(int i) {
        ...
        if (objectMouseOver == null) {
            ...
            if (i == 0) {
                ...
                } else if (itemstack2.stackSize != j1 || playerController.func_35640_h()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    if (Keyboard.getEventKey() == 87) {
                        ...
                        if (currentScreen != null) {
                            ...
                            /*
                             * Check if the key being pressed is recognized by the client
                             * If it is, we call the key press event - Shae
                             * */
                            if (Keyboard.getEventKey() != 0) {
                                Client.getInstance().getEventBus().post(new KeyPressEvent(Keyboard.getEventKey()));
                            }
