...
public class StructureVillagePieces
{
    ...
    public static ArrayList func_35705_a(Random random, int i)
    {
        ...
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageHouse4_Garden.class, 4, MathHelper.func_35598_a(random, 2 + i, 4 + i * 2)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageChurch.class, 20, MathHelper.func_35598_a(random, 0 + i, 1 + i)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageHouse1.class, 20, MathHelper.func_35598_a(random, 0 + i, 2 + i)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageWoodHut.class, 3, MathHelper.func_35598_a(random, 2 + i, 5 + i * 3)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageHall.class, 15, MathHelper.func_35598_a(random, 0 + i, 2 + i)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageField.class, 3, MathHelper.func_35598_a(random, 1 + i, 4 + i)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageField2.class, 3, MathHelper.func_35598_a(random, 2 + i, 4 + i * 2)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageHouse2.class, 15, MathHelper.func_35598_a(random, 0, 1 + i)));
        arraylist.add(new StructureVillagePieceWeight(ComponentVillageHouse3.class, 8, MathHelper.func_35598_a(random, 0 + i, 3 + i * 2)));
