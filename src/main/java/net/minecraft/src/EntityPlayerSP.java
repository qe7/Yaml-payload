...
public class EntityPlayerSP extends EntityPlayer {
    ...
    public void onLivingUpdate() {
        Client.getInstance().getEventBus().post(new UpdateEvent());
        ...
        if (inPortal) {
            ...
            inPortal = false;
        } else if (func_35160_a(Potion.field_35684_k) && func_35167_b(Potion.field_35684_k).func_35802_b() > 60) {
        ...
        if (playerCapabilities.field_35758_c && !flag && movementInput.jump) {
            if (field_35216_aw == 0) {
                field_35216_aw = 7;
            } else {
                playerCapabilities.field_35757_b = !playerCapabilities.field_35757_b;
                field_35216_aw = 0;
            }
        }
        ...
        if (onGround && playerCapabilities.field_35757_b) {
            playerCapabilities.field_35757_b = false;
        }
    }
